...
::: aside
*Slide credits: [Isabella Velásquez](https://github.com/NeubertJonas/velasquez_intro-to-quarto)*
:::
...
My name is Jonas Neubert.

{{< fa brands twitter size=1.4xl >}} jonasjneubert \| {{< fa brands linkedin size=1.4xl >}} ivelasq \| {{< fa brands github size=1.4xl >}} ivelasq \| {{< fa browser size=1.4xl >}} ivelasq.rbind.io
...
-   Session repo with instructions: <https://github.com/NeubertJonas/intro-to-quarto>
-   Exercise repo: <https://github.com/ivelasq/intro-to-quarto-exercises>
-   Original repo by Isabella Velásquez: <https://ivelasq.quarto.pub/intro-to-quarto/>
:::
...
-   Are on the latest version of RStudio (v2023.04) and have cloned the exercise repo
-   And, have a <https://quartopub.com/> account (optional).
:::
